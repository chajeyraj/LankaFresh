        ...
        <footer className="bg-gray-800 text-white">
            <div className="container mx-auto px-6 py-10">
                <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
                    ...
                    {/* Our Branches */}
                    <div>
                        <h3 className="font-semibold uppercase tracking-wide">Our Branches</h3>
                    ...
                    {/* Delivery Info */}
                    <div>
                        <h3 className="font-semibold uppercase tracking-wide">Delivery</h3>
                        <ul className="mt-4 space-y-2 text-sm text-gray-300">
                            <li>🚚 All-island delivery across Sri Lanka</li>
                            <li>✈️ International parcel delivery</li>
                        </ul>
                    ...
                    <div>
                        <h3 className="font-semibold uppercase tracking-wide">Contact Us</h3>
                         <ul className="mt-4 space-y-2 text-sm">
                            <li><a href="https://wa.me/94000000000" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white">💬 WhatsApp</a></li>
                            <li><a href="mailto:support@lankadrop.com" className="text-gray-300 hover:text-white">✉️ support@lankadrop.com</a></li>
                        </ul>
                        <div className="flex space-x-4 mt-4">
                            <a href="https://www.facebook.com/lankadrop" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white">
                             ...
                             <a href="https://www.instagram.com/lankadrop" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white">
